...
For more App features, please see [App Tools]
...
NB: Finally, please note that when  data are loaded or processed (which can take some time depending on the size of the selected data), the error messages may appear on the screen. Simply ignore them, or use this time to read  App documentation and provided references.
